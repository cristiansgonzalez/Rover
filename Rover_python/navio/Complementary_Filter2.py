...
class comp_filt:
	...
	def sal(self,ax,ay,az,gx,gy,gz,mx,my,mz):
		self.attitude3(ax,ay,az,gx,gy,gz,mx,my,mz)
		pitch_d=self.pitch_d#deg
		roll_d=self.roll_d  #deg
		yaw_d=self.yaw_d
		return pitch_d,roll_d,yaw_d