...
int main()
{
   int fd, result,salida,a,b,c,d;
   unsigned char buffer[100];

   cout << "Initializing" << endl ;
	salida = wiringPiI2CSetup(0x1e);
   ...
   cout << "Init result: " << fd << endl;
	printf("Salida: %d\n",salida);
	a= wiringPiI2CReadReg8(salida,1);
	b= wiringPiI2CReadReg8(salida,2); 
	c= wiringPiI2CReadReg8(salida,3); 
	d= wiringPiI2CReadReg8(salida,4);
	printf("Salida 1: %d Salida 2: %d Salida 3: %d Salida 4: %d\n",a,b,c,d);
